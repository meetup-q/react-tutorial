...
# ES6
ES6 又稱 ES2015，可以說是最重要，這一代新增的功能完全改變了 ES 的寫法，新增了 class、async await、arrow function、模組化的功能。
...
# npm
npm 是 node.js 套件管理器（node.js package manager）由 npm inc. 維護。npm inc. 是一家營利公司，2020 年被 microsoft 收購，同年 npm 宣布移入 GitHub。

[^Github 也為 microsoft 的子公司，此舉被解讀為增加 JavaScript 使用人數。]
